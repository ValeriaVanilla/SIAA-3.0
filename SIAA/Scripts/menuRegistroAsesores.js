...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (formRegistro) {
        formRegistro.addEventListener("submit", function (event) {
            validarCampo("nombreInput", "nombreError", "No se permiten números en el nombre", event);
            validarCampo("apellidoPaternoInput", "apellidoPaternoError", "No se permiten números en el apellido paterno", event);
            validarCampo("apellidoMaternoInput", "apellidoMaternoError", "No se permiten números en el apellido materno", event);
            validarCorreo("correoInput", "correoError", event);
        });
    }
});
...
function editarRegistro(id) {
    ...
    // Puedes redirigir a una nueva página o abrir un modal para la edición
    alert('Editar registro con ID: ' + id);
}

function eliminarRegistro(id) {
    // Lógica para eliminar el registro con el ID proporcionado
    // Puedes mostrar un mensaje de confirmación y enviar una solicitud AJAX al servidor para eliminar el registro
